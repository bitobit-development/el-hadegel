    ...
    <div className="min-h-screen bg-background" dir="rtl">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="space-y-6 md:space-y-8 lg:space-y-12">
          {/* Statistics Dashboard - HERO SECTION (moved to top for immediate visibility) */}
          <section className="relative overflow-hidden rounded-2xl bg-white/90 backdrop-blur-sm shadow-xl">
